        ...
        switch (_context.prev = _context.next) {
          ...
          case 6:
            ...
            if (_response.status == 200) {
              console.log("passed: " + JSON.stringify(_response.data.message));
              dispatch({
                field: "message",
                value: _response.data.message
              });
              localStorage.setItem("customerId", _response.data.customer.id);
              localStorage.setItem("token", _response.data.info.token);
              dispatch({
                field: "loading",
                value: false
              });
            } else {
              console.log("failed: " + _response.data);
              dispatch({
                field: "message",
                value: _response.data.message
              });
...
//# sourceMappingURL=account.js.93a1cf46cb0e8d8b9a15.hot-update.js.map